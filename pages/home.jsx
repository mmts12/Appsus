    ...
    return (
      <section className='home-page'>
        ...
        <div className="keep-section main-layout">
          ...
          <h3>Add notes, lists, images, videos and GIFs to Keep. We will make sure to synchronize all the data across your devices so your important stuff is always at your lap</h3>
