      ...
      <section className="about-page main-layout">
        ...
        <div className="team-section flex space-around">
          ...
          <div className="moshiko member-card flex col space-between">
            ...
            <p>Growing up in Amsterdam I was constantly surrounded by modernist design, which very heavily influenced my taste and sensibilities. To me, great design is practical and starts with breaking things down to its simplest form, the straightest line from A to B. Anything superfluous makes me uneasy. I frequently have heated debates on how things can be done better with less stuff.</p>
          </div>
